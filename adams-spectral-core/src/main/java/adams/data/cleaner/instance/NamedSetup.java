...
/**
 <!-- globalinfo-start -->
 * Applies an instance cleaner that is referenced via its global setup name (see 'NamedSetups').
 * <br><br>
 <!-- globalinfo-end -->
 *
 <!-- options-start -->
...
public class NamedSetup
  ...
  /** for serialization. */
  private static final long serialVersionUID = 8319462864575625756L;
  ...
  public String globalInfo() {
    return "Applies an instance cleaner that is referenced via its global setup name (see 'NamedSetups').";
  }
  ...
  /**
   * Default cleaner that does nothing.
   *
