...
/**
 * ReportColorSpectrumPaintlet.java
 ...
 * @version $Revision$
 */
public class ReportColorSpectrumPaintlet
  ...
  public String globalInfo() {
    return "Paintlet for painting the spectral data using the color stored in the report.";
  }
  ...
  public Color getColor(int index) {
    ...
    cont   = (SpectrumContainer) getDataContainerPanel().getContainerManager().get(index);
