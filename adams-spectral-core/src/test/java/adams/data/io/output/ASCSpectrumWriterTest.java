...
/**
 * Test class for the ASCSpectrumWriter data container. Run from the command line with: <br><br>
 * java knir.data.output.ASCSpectrumWriterTest
 *
...
public class ASCSpectrumWriterTest
   ...
   */
  public ASCSpectrumWriterTest(String name) {
    super(name);
  }
  ...
  public static Test suite() {
    return new TestSuite(ASCSpectrumWriterTest.class);
  }
