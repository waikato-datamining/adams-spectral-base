...
/**
 * Test class for the NamedSetup cleaner. Run from the command line with: <br><br>
 * java adams.data.cleaner.spectrum.NamedSetupTest
 *
...
public class NamedSetupTest
  ...
  protected AbstractCleaner[] getRegressionSetups() {
    ...
    result[0].setSetup(new adams.core.NamedSetup("spectrum_cleaner_passthrough"));
