 ...
 */
public class DistributeSampleDataTest
   ...
   */
  public DistributeSampleDataTest(String name) {
    super(name);
  }
  ...
  public static Test suite() {
    return new TestSuite(DistributeSampleDataTest.class);
  }
