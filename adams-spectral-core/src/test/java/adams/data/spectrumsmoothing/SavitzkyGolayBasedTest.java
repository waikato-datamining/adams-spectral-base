 ...
 * java adams.data.spectrumsmoothing.SavitzkyGolayBasedTest
 *
 * @author  fracpete (fracpete at waikato dot ac dot nz)
 * @version $Revision: 2242 $
 */
public class SavitzkyGolayBasedTest
   ...
   */
  public SavitzkyGolayBasedTest(String name) {
    super(name);
  }
  ...
  protected AbstractSmoother[] getRegressionSetups() {
    SavitzkyGolayBased[]	result;

    result = new SavitzkyGolayBased[2];

    result[0] = new SavitzkyGolayBased();
    result[1] = new SavitzkyGolayBased();
