...
/**
 * Test class for the FakeEvaluator evaluator. Run from the command line with: <br><br>
 * java adams.data.evaluator.instance.FakeEvaluatorTest
 *
 * @author FracPete (fracpete at waikato dot ac dot nz)
 * @version $Revision$
 */
public class FakeEvaluatorTest
   ...
   */
  public FakeEvaluatorTest(String name) {
    super(name);
  }
  ...
  public static Test suite() {
    return new TestSuite(FakeEvaluatorTest.class);
  }
