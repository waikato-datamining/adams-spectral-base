...
/**
 * Test class for the DistanceToClosest evaluator. Run from the command line with: <br><br>
 * java adams.data.evaluator.instance.DistanceToClosestTest
 *
 * @author FracPete (fracpete at waikato dot ac dot nz)
 * @version $Revision$
 */
public class DistanceToClosestTest
   ...
   */
  public DistanceToClosestTest(String name) {
    super(name);
  }
  ...
  public static Test suite() {
    return new TestSuite(DistanceToClosestTest.class);
  }
