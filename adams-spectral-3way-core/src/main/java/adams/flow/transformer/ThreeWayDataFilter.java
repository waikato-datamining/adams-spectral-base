...
import adams.flow.container.ThreeWayDataFilterContainer;
 ...
 * Input&#47;output:<br>
 * - accepts:<br>
 * &nbsp;&nbsp;&nbsp;knir.data.spectrum.ThreeWayData<br>
 * - generates:<br>
 * &nbsp;&nbsp;&nbsp;knir.data.spectrum.ThreeWayData<br>
 * <br><br>
 <!-- flow-summary-end -->
 ...
 */
public class ThreeWayDataFilter
  ...
  protected Class getOutputContainerClass() {
    return ThreeWayDataFilterContainer.class;
  }
