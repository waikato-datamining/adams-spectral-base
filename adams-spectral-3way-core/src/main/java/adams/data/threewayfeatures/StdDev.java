...
public class StdDev
  ...
  public String globalInfo() {
    return "Determines the sample standard deviation of all the data values.";
  }
  ...
  public HeaderDefinition createHeader(ThreeWayData data) {
    ...
    result.add("stdev", DataType.NUMERIC);
  ...
  public List<Object>[] generateRows(ThreeWayData data) {
    ...
    result[0].add(StatUtils.stddev(values.toArray(), true));
