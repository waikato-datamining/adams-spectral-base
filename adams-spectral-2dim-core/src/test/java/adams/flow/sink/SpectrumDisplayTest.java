...
/**
 * Tests the SpectrumDisplay actor.
 *
 * @author  fracpete (fracpete at waikato dot ac dot nz)
 * @version $Revision: 1865 $
 */
public class SpectrumDisplayTest
   ...
   */
  public SpectrumDisplayTest(String name) {
    super(name);
  }
  ...
  public Actor getActor() {
    ...
    SpectrumDisplay disp = new SpectrumDisplay();
  ...
  public static Test suite() {
    return new TestSuite(SpectrumDisplayTest.class);
  }
