...
/**
 * Tests the SpectrumIdSupplier/Writer actor.
 *
 * @author  fracpete (fracpete at waikato dot ac dot nz)
 * @version $Revision: 1286 $
 */
public class SpectrumIdSupplierTest
   ...
   */
  public SpectrumIdSupplierTest(String name) {
    super(name);
  }
  ...
  public Actor getActor() {
    ...
    Flow flow = new Flow();
    flow.setActors(new Actor[]{dbcon, id, df});
  ...
  public static Test suite() {
    return new TestSuite(SpectrumIdSupplierTest.class);
  }
