...
/**
 * Test class for the SavitzkyGolayRange evaluator. Run from the command line with: <br><br>
 * java adams.data.evaluator.instance.SavitzkyGolayRangeTest
 *
 * @author FracPete (fracpete at waikato dot ac dot nz)
 * @version $Revision$
 */
public class SavitzkyGolayRangeTest
   ...
   */
  public SavitzkyGolayRangeTest(String name) {
    super(name);
  }
  ...
  protected AbstractEvaluator[] getRegressionSetups() {
    return new SavitzkyGolayRange[]{
      new SavitzkyGolayRange(),
    };
  }
  ...
  public static Test suite() {
    return new TestSuite(SavitzkyGolayRangeTest.class);
  }
