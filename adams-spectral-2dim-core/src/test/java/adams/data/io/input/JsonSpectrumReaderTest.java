...
/**
 * Test class for the JsonSpectrumReader data container. Run from the command line with: <br><br>
...
public class JsonSpectrumReaderTest
   ...
   */
  public JsonSpectrumReaderTest(String name) {
    super(name);
  }
  ...
  public static Test suite() {
    return new TestSuite(JsonSpectrumReaderTest.class);
  }
