 ...
 * java adams.data.cleaner.instance.MinMaxTest
 *
...
public class MinMaxTest
  ...
  protected AbstractCleaner[] getRegressionSetups() {
    ...
    result[0] = new MinMax();
    result[0].setAttributeName("Clay");

    result[1] = new MinMax();
    result[1].setMinimum(100.0);
    result[1].setAttributeName("Clay");

    result[2] = new MinMax();
    result[2].setMaximum(200.0);
    result[2].setAttributeName("Clay");

    result[3] = new MinMax();
    result[3].setMinimum(100.0);
    result[3].setMaximum(200.0);
    result[3].setAttributeName("Clay");
