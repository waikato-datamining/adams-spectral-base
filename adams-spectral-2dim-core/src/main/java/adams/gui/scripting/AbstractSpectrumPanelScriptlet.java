...
/**
 * AbstractSpectrumPanelScriptlet.java
...
public abstract class AbstractSpectrumPanelScriptlet
  ...
  /** for serialization. */
  private static final long serialVersionUID = -8241837004494643440L;
  ...
  public Class[] getRequirements() {
    return new Class[]{SpectrumPanel.class};
  }
  ...
  public SpectrumPanel getSpectrumPanel() {
    if (hasOwner())
      return (SpectrumPanel) getOwner().getBasePanel();
    else
      return null;
  }
}
