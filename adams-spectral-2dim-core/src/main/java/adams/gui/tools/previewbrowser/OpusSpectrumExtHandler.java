...
/*
 * OpusSpectrumExtHandler.java
 * Copyright (C) 2018 University of Waikato, Hamilton, New Zealand
 */
package adams.gui.tools.previewbrowser;

import adams.data.io.input.AbstractSpectrumReader;
import adams.data.io.input.OpusSpectrumReaderExt;
 ...
 */
public class OpusSpectrumExtHandler
  ...
  public String[] getExtensions() {
    return new OpusSpectrumReaderExt().getFormatExtensions();
  }
  ...
  protected AbstractSpectrumReader getReader(File file) {
    return new OpusSpectrumReaderExt();
  }
}
