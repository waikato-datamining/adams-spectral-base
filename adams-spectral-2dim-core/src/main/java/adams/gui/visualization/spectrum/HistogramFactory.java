...
public class HistogramFactory {
  ...
  public static class Panel
     ...
     * @param c		the spectrum to create a plot for
     */
    public void add(ArrayHistogram hist, Spectrum c) {
      add(hist, c, "DB-ID " + c.getDatabaseID());
    }
     ...
     */
    public void add(ArrayHistogram hist, Spectrum c, String name) {
      Double[]			data;
