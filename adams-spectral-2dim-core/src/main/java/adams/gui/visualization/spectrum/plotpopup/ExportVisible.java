...
public class ExportVisible
  ...
  public void customize(DataContainerPanelWithContainerList<Spectrum, SpectrumContainerManager, SpectrumContainer> panel, MouseEvent e, JPopupMenu menu) {
    ...
    item = new JMenuItem("Export visible...", ImageManager.getIcon("arff.png"));
    item.addActionListener((ActionEvent ae) -> ((SpectrumPanel) panel).exportVisibleSpectra());
    menu.add(item);
  }
}
