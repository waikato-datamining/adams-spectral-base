...
/*
 * SimpleSpectralInstanceGenerator.java
 ...
 */
public class SimpleSpectralInstanceGenerator
  ...
  public String globalInfo() {
    return
      ...
      + "sample data into weka.core.Instance objects (without class attribute).";
  }
  ...
  protected void generateHeader(Spectrum data) {
    ...
    m_OutputHeader = new Instances(getClass().getName(), atts, 0);
    m_OutputHeader.setClassIndex(-1);
  }
