...
import adams.data.baseline.AbstractCenteredMovingAverageBased;
...
/**
 <!-- globalinfo-start -->
 * A baseline correction scheme that uses CenteredMovingAverage smoothing to determine the baseline.<br>
 * <br>
...
public class CenteredMovingAverageBased
  ...
  /**
   * Returns a new instance of a CenteredMovingAverage filter.
   *
   * @return		the filter
   */
  @Override
  protected AbstractCenteredMovingAverage getFilter() {
