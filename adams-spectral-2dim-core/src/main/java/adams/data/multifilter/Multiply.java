 ...
 * &nbsp;&nbsp;&nbsp;The formats of the two spectra to multiply.
 * &nbsp;&nbsp;&nbsp;default: 
 * </pre>
 * 
 * <pre>-new-format &lt;java.lang.String&gt; (property: newFormat)
 * &nbsp;&nbsp;&nbsp;The new format to use for the multiplied spectrum.
 * &nbsp;&nbsp;&nbsp;default: MUL
 * </pre>
 * 
 <!-- options-end -->
...
public class Multiply
  ...
  public String formatsTipText() {
    return "The formats of the two spectra to multiply.";
  }
  ...
  public String newFormatTipText() {
    return "The new format to use for the multiplied spectrum.";
  }
