...
import adams.data.filter.AbstractHistogram;
...
public class Histogram
  extends AbstractHistogram<Spectrum> {
  ...
  public String globalInfo() {
    return "Generates a histogram from the spectrum.";
  }
  ...
  protected DataPoint newDataPoint(int index, double y) {
    return new SpectrumPoint((float) (index + 1), (float) y);
  }
}
