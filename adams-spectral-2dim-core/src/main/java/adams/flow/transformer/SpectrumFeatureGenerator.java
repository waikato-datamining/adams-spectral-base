...
public class SpectrumFeatureGenerator
  ...
  protected transient AbstractSpectrumFeatureGenerator m_ActualAlgorithm;
  ...
  protected void restoreState(Hashtable<String,Object> state) {
    ...
    if (state.containsKey(BACKUP_ALGORITHM)) {
      m_ActualAlgorithm = (AbstractSpectrumFeatureGenerator) state.get(BACKUP_ALGORITHM);
  ...
  protected String doExecute() {
    ...
    try {
      ...
      m_Queue.addAll(Arrays.asList(m_ActualAlgorithm.generate((Spectrum) m_InputToken.getPayload())));
    }
    catch (Exception e) {
