...
/*
 * SpectralDbBackendDefinition.java
 * Copyright (C) 2019 University of Waikato, Hamilton, New Zealand
 */
package adams.env;

import adams.db.SpectralDbBackend;
 ...
 */
public class SpectralDbBackendDefinition
  ...
  /** the key as constant. */
  public final static String KEY = "spectral db backend implementations";
  ...
  public String getFile() {
    return SpectralDbBackend.FILENAME;
  }
