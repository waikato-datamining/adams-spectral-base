 ...
 * @version $Revision: 2127 $
 */
public class SpectralGetServiceWS
  ...
  protected SpectralGetService m_Implementation;
  ...
  public void defineOptions() {
	...
	new adams.flow.webservice.SimpleSpectralGetService());
  }
  ...
  public String getDefaultURL() {
    return "http://localhost:9090/SpectralGetServicePort";
  }
   ...
   */
  public void setImplementation(SpectralGetService value) {
   ...
   */
  public SpectralGetService getImplementation() {
  ...
  protected void doStart() throws Exception {
    SpectralGetService implementer;

    implementer = (SpectralGetService) WebserviceUtils.copyImplementation(m_Implementation);
    if (implementer instanceof adams.flow.webservice.OwnedBySpectralGetServiceWS)
      ((adams.flow.webservice.OwnedBySpectralGetServiceWS) implementer).setOwner(this);
