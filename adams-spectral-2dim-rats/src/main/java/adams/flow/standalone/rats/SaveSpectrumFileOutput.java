 ...
 * @version $Revision$
 */
public class SaveSpectrumFileOutput
  ...
  public String globalInfo() {
    return "Writes the input spectrum to the file that the filename generator produces.";
  }
  ...
  protected String doTransmit() {
    ...
    if (result == null) {
      ...
      ok = m_Writer.write(input);
      if (!ok)
	getLogger().severe("Failed to write spectrum " + input + " to '" + file + "'!");
      else if (isLoggingEnabled())
	getLogger().info("Spectrum " + input + " written to: " + file);
    }
