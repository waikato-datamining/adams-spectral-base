...
import adams.flow.webservice.spectrum.RatsSpectrumServiceWS;
 ...
 */
public class WSSpectrumReception
  ...
  protected List<Spectrum> m_Data;
  ...
  protected WebServiceProvider getDefaultWebService() {
    return new RatsSpectrumServiceWS();
  }
