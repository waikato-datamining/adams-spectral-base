...
public class RatsSpectrumServiceWS
  ...
  public String getDefaultURL() {
    return "http://localhost:9090/RatsSpectrumServicePort";
  }
  ...
  protected void doStart() throws Exception {
    RatsSpectrumService implementer;

    implementer = (RatsSpectrumService) WebserviceUtils.copyImplementation(m_Implementation);
    if (implementer instanceof OwnedByRatsSpectrumServiceWS)
      ((OwnedByRatsSpectrumServiceWS) implementer).setOwner(this);
