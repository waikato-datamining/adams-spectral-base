...
/*
 * DeleteSampleDataValueTest.java
...
/**
 * Tests the DeleteSampleDataValue actor.
 *
 * @author  fracpete (fracpete at waikato dot ac dot nz)
 * @version $Revision: 1865 $
 */
public class DeleteSampleDataValueTest
   ...
   */
  public DeleteSampleDataValueTest(String name) {
    super(name);
  }
  ...
  public Actor getActor() {
    ...
    DeleteSampleDataValue gv = new DeleteSampleDataValue();
    gv.setFields(new Field[]{new Field("GLV2", DataType.NUMERIC)});

    GetReport getr = new GetReport();
    ...
    Flow flow = new Flow();
    flow.setActors(new Actor[]{sfs, sfr, gv, getr, df});
  ...
  public static Test suite() {
    return new TestSuite(DeleteSampleDataValueTest.class);
  }
