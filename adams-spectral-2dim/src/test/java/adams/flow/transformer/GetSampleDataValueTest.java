...
/**
 * Tests the GetSampleDataValue actor.
 *
 * @author  fracpete (fracpete at waikato dot ac dot nz)
 * @version $Revision: 1865 $
 */
public class GetSampleDataValueTest
   ...
   */
  public GetSampleDataValueTest(String name) {
    super(name);
  }
  ...
  public Actor getActor() {
    ...
    Flow flow = new Flow();
    flow.setActors(new Actor[]{sfs, sfr, gv, df});
  ...
  public static Test suite() {
    return new TestSuite(GetSampleDataValueTest.class);
  }
