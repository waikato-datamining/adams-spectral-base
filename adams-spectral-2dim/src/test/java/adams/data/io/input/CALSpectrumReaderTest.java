 ...
 */
public class CALSpectrumReaderTest
   ...
   */
  public CALSpectrumReaderTest(String name) {
    super(name);
  }
  ...
  public static Test suite() {
    return new TestSuite(CALSpectrumReaderTest.class);
  }
