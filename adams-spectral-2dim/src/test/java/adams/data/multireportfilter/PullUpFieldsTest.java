...
public class PullUpFieldsTest
   ...
   */
  public PullUpFieldsTest(String name) {
    super(name);
  }
  ...
  protected AbstractMultiSpectrumReportFilter[] getRegressionSetups() {
    ...
    result = new PullUpFields[1];
    result[0] = new PullUpFields();
    result[0].setFields(new Field[]{new Field("Value3", DataType.STRING)});
  ...
  public static Test suite() {
    return new TestSuite(PullUpFieldsTest.class);
  }
