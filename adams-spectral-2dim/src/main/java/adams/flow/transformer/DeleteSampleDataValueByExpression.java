...
/**
 * DeleteSampleDataValueByExpression.java
 ...
 * @version $Revision$
 */
public class DeleteSampleDataValueByExpression
  ...
  public String globalInfo() {
    return
      "Deletes a field and its value from sample data if the provided boolean "
  ...
  public String fieldTipText() {
    return "The field to remove from the sample data if the expression evaluates to true.";
  }
